...
# IPTV Backend API Test Suite - Corrected Version
# This script tests all APIs with proper DTO structures
...
# Create category 2
cat2_data='{
  "original_name": "TV Shows",
  "use_for": ["series", "vod"],
  "show_name_on_application": "TV Shows",
  "order": 2,
  "status": true
}'
...
if [ -n "$cat1_id" ] && [ "$cat1_id" != "null" ]; then
    subcat1_data='{
      "original_name": "Action Thriller",
      "category_id": "'$cat1_id'",
      "show_name_on_application": "Thriller",
      "description": "High-intensity action thriller movies",
      "order": 1,
      "status": true
    }'
